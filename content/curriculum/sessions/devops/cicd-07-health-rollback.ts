...
export default createInventoryExpertSession({
  "inventoryId": "cicd-07-health-rollback",
  "slug": "cicd-07-health-rollback",
  "courseId": "devops",
  "moduleId": "registry-ec2-deployment",
  "order": 7,
  "title": "health check, 실패 감지와 이전 digest 롤백",
  "level": "전문가",
  ...
  "sourceNotes": [
    "Actions 로그, 이미지 digest, 컨테이너 상태와 HTTP health check로 health check 산출물의 동일성을 확인한다.",
    "빌드 실패·인증 실패·배포 실패를 구분하고 이전 버전 서비스가 유지되거나 복구되는지 확인한다.",
    "원본 예제 의도: health check, 실패 감지와 이전 digest 롤백를 최소 workflow/Dockerfile/배포 명령으로 구성하고 각 단계의 입력과 산출물을 표시한다.",
    "원본 예제 의도: rollback 실패를 의도적으로 만들어 로그·종료 코드·재시도·롤백 동작을 검증한다."
  ],
  "expertNotes": [
  ...
  "prerequisiteSlugs": [
    "cicd-06-ssh-container-lifecycle"
  ],
  "nextSlug": "cicd-08-zero-downtime"
});
