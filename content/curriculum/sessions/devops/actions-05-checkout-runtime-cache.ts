...
export default createInventoryExpertSession({
  "inventoryId": "actions-05-checkout-runtime-cache",
  "slug": "actions-05-checkout-runtime-cache",
  "courseId": "devops",
  "moduleId": "actions-workflow-ci",
  "order": 5,
  "title": "checkout·setup-node/JDK와 의존성 캐시",
  "level": "중급",
  "estimatedMinutes": 90,
  "concepts": [
    "actions/checkout",
  ...
  "sourceNotes": [
    "Actions 로그, 이미지 digest, 컨테이너 상태와 HTTP health check로 actions/checkout 산출물의 동일성을 확인한다.",
    "빌드 실패·인증 실패·배포 실패를 구분하고 이전 버전 서비스가 유지되거나 복구되는지 확인한다.",
    "원본 예제 의도: checkout·setup-node/JDK와 의존성 캐시를 최소 workflow/Dockerfile/배포 명령으로 구성하고 각 단계의 입력과 산출물을 표시한다.",
    "원본 예제 의도: setup-node·setup-java 실패를 의도적으로 만들어 로그·종료 코드·재시도·롤백 동작을 검증한다."
  ],
  "expertNotes": [
  ...
  "prerequisiteSlugs": [
    "actions-04-secrets-masking"
  ],
  "nextSlug": "actions-06-build-test-artifact"
});
