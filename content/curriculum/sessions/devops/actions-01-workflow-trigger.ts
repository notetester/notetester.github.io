...
export default createInventoryExpertSession({
  "inventoryId": "actions-01-workflow-trigger",
  "slug": "actions-01-workflow-trigger",
  "courseId": "devops",
  "moduleId": "actions-workflow-ci",
  "order": 1,
  "title": "workflow name·on 트리거와 branch 조건",
  "level": "입문",
  "estimatedMinutes": 70,
  "concepts": [
    "workflow",
  ...
  "sourceNotes": [
    "Actions 로그, 이미지 digest, 컨테이너 상태와 HTTP health check로 workflow 산출물의 동일성을 확인한다.",
    "빌드 실패·인증 실패·배포 실패를 구분하고 이전 버전 서비스가 유지되거나 복구되는지 확인한다.",
    "원본 예제 의도: workflow name·on 트리거와 branch 조건를 최소 workflow/Dockerfile/배포 명령으로 구성하고 각 단계의 입력과 산출물을 표시한다.",
    "원본 예제 의도: push·pull_request 실패를 의도적으로 만들어 로그·종료 코드·재시도·롤백 동작을 검증한다."
  ],
  "expertNotes": [
  ...
  "prerequisiteSlugs": [
    "security-21-full-security-capstone"
  ],
  "nextSlug": "actions-02-jobs-runner-steps"
});
