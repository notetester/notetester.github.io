...
export default createInventoryExpertSession({
  "inventoryId": "actions-04-secrets-masking",
  "slug": "actions-04-secrets-masking",
  "courseId": "devops",
  "moduleId": "actions-workflow-ci",
  "order": 4,
  "title": "Actions secrets, 마스킹과 안전한 전달",
  "level": "중급",
  "estimatedMinutes": 90,
  "concepts": [
    "repository secret",
  ...
  "sourceNotes": [
    "Actions 로그, 이미지 digest, 컨테이너 상태와 HTTP health check로 repository secret 산출물의 동일성을 확인한다.",
    "빌드 실패·인증 실패·배포 실패를 구분하고 이전 버전 서비스가 유지되거나 복구되는지 확인한다.",
    "원본 예제 의도: Actions secrets, 마스킹과 안전한 전달를 최소 workflow/Dockerfile/배포 명령으로 구성하고 각 단계의 입력과 산출물을 표시한다.",
    "원본 예제 의도: masking 실패를 의도적으로 만들어 로그·종료 코드·재시도·롤백 동작을 검증한다."
  ],
  "expertNotes": [
  ...
  "prerequisiteSlugs": [
    "actions-03-run-uses-context"
  ],
  "nextSlug": "actions-05-checkout-runtime-cache"
});
