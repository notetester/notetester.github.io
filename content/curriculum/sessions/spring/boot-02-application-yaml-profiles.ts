...
const session = createExpertSession({
  ...
  lab: {
    ...
    goal: "sanitized fixture에서 모든 source/profile 조합의 effective origin과 typed binding을 검증하고 secret rotation, canary와 rollback evidence를 완성합니다.",
    prerequisites: ["JDK 21", "원본과 호환되는 Gradle Wrapper", "격리된 Boot fixture", "synthetic canary secret", "원본 files read-only", "실제 production DB/credential 접근 금지"],
