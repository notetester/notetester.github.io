...
const session = createExpertSession({
  ...
  lab: {
    ...
    cleanup: ["격리 schemas/users, synthetic rows, locks/jobs, reports와 restore artifacts를 제거합니다.", "temporary credentials/backups/exports를 revoke·삭제합니다.", "logs/fixtures에 원본 theater/movie/customer names, addresses와 dates가 없는지 검사합니다.", "D:\\dev\\dbstudy\\HOMEWORK.sql과 production data는 변경하지 않습니다."],
