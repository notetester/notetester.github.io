...
const session = createExpertSession({
  ...
  lab: {
    ...
    cleanup: ["격리 functions, grants/users, synthetic tables, expression indexes/generated columns와 caches를 dependency 역순으로 제거합니다.", "temporary credentials, collision reports와 traces를 revoke·삭제합니다.", "logs에 raw text/argument/return 또는 원본 sample 개인 정보가 없는지 검사합니다.", "dbstudy/02_04.sql과 production data는 변경하지 않습니다."],
