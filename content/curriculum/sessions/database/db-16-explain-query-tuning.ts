...
const sources: SessionSource[] = [
  ...
  { id: "mysql-explain-analyze", repository: "MySQL 8.4 Reference Manual", path: "Obtaining Information with EXPLAIN ANALYZE", publicUrl: "https://dev.mysql.com/doc/refman/8.4/en/explain-analyze.html", usedFor: ["actual rows, loops and timing safety"], evidence: "MySQL 공식 EXPLAIN ANALYZE 문서입니다." },
