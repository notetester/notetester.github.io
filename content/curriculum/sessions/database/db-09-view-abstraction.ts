...
const session = createExpertSession({
  ...
  lab: {
    ...
    cleanup: ["격리 schemas, synthetic users/grants, views/triggers/summary tables를 dependency 역순으로 제거합니다.", "temporary credentials와 exports를 revoke·삭제합니다.", "audit/log에 raw row values나 원본 sample 개인 정보가 없는지 검사합니다.", "dbstudy 원본 파일과 production data는 변경하지 않습니다."],
