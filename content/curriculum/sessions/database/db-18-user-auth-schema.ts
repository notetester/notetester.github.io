...
const session = createExpertSession({
  ...
  lab: {
    ...
    cleanup: ["격리 schemas/users/keys, synthetic identities/tokens/events와 migration/restore artifacts를 제거합니다.", "temporary peppers/credentials/backups/exports를 revoke·crypto-erase/삭제합니다.", "logs/fixtures에 원본 identifiers, email, tokens, IP/user-agent/detail messages가 없는지 검사합니다.", "D:\\dev\\dbstudy\\USERS.sql과 production data는 변경하지 않습니다."],
