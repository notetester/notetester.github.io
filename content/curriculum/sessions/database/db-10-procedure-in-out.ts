...
const session = createExpertSession({
  ...
  lab: {
    ...
    cleanup: ["격리 routines, grants/users, synthetic tables/command logs와 telemetry fixtures를 제거합니다.", "temporary DB credentials와 exported traces를 revoke·삭제합니다.", "logs에 raw parameters, 원본 이름·주소·전화번호 또는 SQL value가 없는지 검사합니다.", "dbstudy/02_04.sql과 production data는 변경하지 않습니다."],
