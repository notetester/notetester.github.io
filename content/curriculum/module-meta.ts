...
export const moduleMeta: ModuleMeta[] = [
  ...
  { courseId: "python", id: "gap-python-runtime", order: 5, title: "Python 런타임·설계·패키징", description: "객체 identity·GC와 descriptor·Protocol·decorator·generator에서 pyproject·wheel·고급 타입 검사까지 보강합니다." },
  { courseId: "python", id: "gap-concurrency-ops", order: 6, title: "Python 동시성·운영·테스트", description: "threading·multiprocessing·asyncio의 취소와 backpressure를 운영 설정·logging·CLI·DB·property test·CI로 연결합니다." },
  { courseId: "machine-learning", id: "ml-framing-knn", order: 1, title: "문제 정의와 첫 지도학습", description: "예측 목표·단위·label·split을 먼저 고정하고 NumPy·pandas·KNN으로 첫 분류·회귀 pipeline을 검증합니다." },
  { courseId: "machine-learning", id: "ml-regression-features", order: 2, title: "회귀·특성공학·규제", description: "선형·다항 회귀와 scaling·encoding·regularization을 leakage 없는 Pipeline과 coefficient 진단으로 익힙니다." },
  { courseId: "machine-learning", id: "ml-classification-optimization", order: 3, title: "확률 분류·최적화", description: "logistic probability·loss·gradient·learning rate와 multiclass decision boundary를 threshold 정책과 함께 다룹니다." },
  { courseId: "machine-learning", id: "ml-evaluation-trees", order: 4, title: "평가·검증·트리 앙상블", description: "confusion matrix·precision/recall·ROC/PR·cross-validation에서 tree·random forest·feature importance와 tuning까지 확장합니다." },
  { courseId: "machine-learning", id: "ml-margin-boosting-unsupervised", order: 5, title: "SVM·부스팅·비지도학습", description: "margin/kernel과 gradient boosting을 해석하고 clustering·PCA의 scale·metric·stability를 실험 설계로 검증합니다." },
  { courseId: "deep-learning", id: "dl-ann-dnn", order: 1, title: "ANN·DNN 기초", description: "tensor·layer·activation·loss·backpropagation과 optimizer를 작은 수치 예제에서 multilayer network로 연결합니다." },
  { courseId: "deep-learning", id: "dl-training", order: 2, title: "훈련·규제·실험 추적", description: "initialization·normalization·dropout·scheduler·early stopping과 reproducible checkpoint·metric tracking을 다룹니다." },
  { courseId: "deep-learning", id: "dl-cnn", order: 3, title: "CNN·이미지 분류·해석", description: "convolution shape·padding·stride·pooling에서 augmentation·class imbalance·CAM과 failure analysis까지 확장합니다." },
  { courseId: "deep-learning", id: "dl-transfer", order: 4, title: "전이학습·입력 파이프라인", description: "pretrained feature와 freeze/unfreeze·differential learning rate를 deterministic data loader·normalization·deployment input contract로 연결합니다." },
  { courseId: "deep-learning", id: "dl-sequence-nlp", order: 5, title: "RNN·임베딩·한국어 NLP", description: "sequence padding·mask·embedding과 RNN/LSTM/GRU를 tokenization·OOV·한국어 감성분석·attention의 한계까지 다룹니다." },
  { courseId: "langchain-rag", id: "rag-llm-lcel", order: 1, title: "LLM·Prompt·LCEL", description: "model/message/token 경계와 prompt template·structured output·LCEL runnable·streaming·retry를 검증합니다." },
  { courseId: "langchain-rag", id: "rag-memory", order: 2, title: "대화 기록·컨텍스트 관리", description: "chat history·window·summary·token budget과 tenant/session isolation을 기억의 정확성·privacy·deletion 관점에서 설계합니다." },
  { courseId: "langchain-rag", id: "rag-retrieval", order: 3, title: "문서 수집·청킹·검색·근거 생성", description: "loader·metadata·chunking·embedding·vector store·hybrid/rerank·citation과 retrieval evaluation을 하나의 provenance pipeline으로 묶습니다." },
  { courseId: "langchain-rag", id: "rag-ui-production", order: 4, title: "RAG UI·평가·운영", description: "Streamlit chat UX와 ingestion status·golden set·faithfulness·latency/cost·prompt injection·observability·rollback을 운영합니다." },
  { courseId: "projects", id: "coach-ai-flow", order: 1, title: "CoachBot AI 요청·사용자 경험", description: "Express AI route·validation·prompt·typed frontend errors·MediaRecorder를 면접 질문·피드백 경험과 연결합니다." },
  { courseId: "projects", id: "coach-domain-ops", order: 2, title: "CoachBot 도메인·데이터·운영", description: "평가·승인·멘토 도메인과 MySQL migration·seed·AI 비용·보안·관측·fallback 체크리스트를 다룹니다." },
  { courseId: "projects", id: "gap-data-ai-production", order: 3, title: "데이터·AI 프로덕션 보강", description: "NumPy·pandas 성능과 데이터 계약에서 ML fairness·drift, DL mixed precision·분산, RAG 평가·공격 방어까지 전문가 공백을 메웁니다." },
];
